        ...
        <form action="{{ route('educationstore') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="hsc_board" id="hsc_board" placeholder="HSC Board Name" value="{{ old('hsc_board') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="hsc_group" id="hsc_group" placeholder="HSC Group Name" value="{{ old('hsc_group') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="hsc_result" id="hsc_result" placeholder="HSC Result" value="{{ old('hsc_result') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="hsc_passing" id="hsc_passing" placeholder="HSC Passing Year" value="{{ old('hsc_passing') }}">
            ...
            <div class="mb-3">
                <label for="ssc_board" class="form-label">HSC Board Name</label>
                <input type="text"
                    class="form-control @error('ssc_board') is-invalid @enderror {{ old('ssc_board') ? 'is-valid':'' }}"
                    name="ssc_board" id="ssc_board" placeholder="SSC Board Name" value="{{ old('ssc_board') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="ssc_group" id="ssc_group" placeholder="SSC Group Name" value="{{ old('ssc_group') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="ssc_result" id="ssc_result" placeholder="SSC Result" value="{{ old('ssc_result') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="ssc_passing" id="ssc_passing" placeholder="SSC Passing Year" value="{{ old('ssc_passing') }}">
