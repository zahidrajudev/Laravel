        ...
        <form action="{{ route('personalstore') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="name" id="name" placeholder="Your Full name" value="{{ old('name') }}">
            ...
            <div class="mb-3">
                ...
                <input type="date"
                    ...
                    name="birth_date" id="birth_date" placeholder="Date Of Birth" value="{{ old('birth_date') }}">
                @error('birth_date')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    value="{{ old('nationality') ? old('nationality') : 'Bangladeshi' }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="religion" id="religion" placeholder="Your Religion" value="{{ old('religion') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    class="form-control @error('sex') is-invalid @enderror {{ old('sex') ? 'is-valid':'' }}" name="sex"
                    id="sex" placeholder="Male / Female" value="{{ old('sex') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="height" id="height" placeholder="5 Feet 4 Inch" value="{{ old('height') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="weight" id="weight" placeholder="Ex. 55 KG" value="{{ old('weight') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    class="form-control @error('nid') is-invalid @enderror {{ old('nid') ? 'is-valid':'' }}" name="nid"
                    id="nid" placeholder="Ex.1784268765" value="{{ old('nid') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="pa_village" id="pa_village" placeholder="Village name" value="{{ old('pa_village') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="pa_upazila" id="pa_upazila" placeholder="upazila Name" value="{{ old('pa_upazila') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    name="pa_district" id="pa_district" placeholder="District name" value="{{ old('pa_district') }}">
