                    ...
                    <form action="{{ route('skillupdate') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                value="{{ old('computer_ms') ? old('computer_ms') : $resume->computer_ms }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                value="{{ old('internet') ? old('internet') : $resume->internet }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                value="{{ old('english') ? old('english') : $resume->english }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                name="bangla" id="bangla" value="{{ old('bangla') ? old('bangla') : $resume->bangla }}">
